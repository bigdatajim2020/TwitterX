...
class ProfileDataFormViewController: UIViewController {
    ...
    private func configureConstraints(){
        ...
        let hintLabelConstraints = [
            hintLable.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor),
            hintLable.topAnchor.constraint(equalTo: scrollView.topAnchor, constant: 30)
        ]
        ...
        let avatarPlaceholderImageViewConstraints = [
            ...
            avatarPlaceholderImageView.topAnchor.constraint(equalTo: hintLable.bottomAnchor, constant: 30),
        ...
        let submitButtonConstraints = [
            ...
            submitButton.bottomAnchor.constraint(equalTo: view.keyboardLayoutGuide.topAnchor, constant: -50),
